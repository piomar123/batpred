...
from tests.test_net_settlement_windows import run_net_settlement_window_tests
...
def main():
    ...
    TEST_REGISTRY = [
        ...
        ("net_settlement_windows", run_net_settlement_window_tests, "Net-settlement-aware iBoost and car charging decisions", False),
